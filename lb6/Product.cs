namespace ClassLibraryProduct
{
    public abstract class Product : IComparable
    {
        ...
        public Product(string name) : this() => SetName(name);
        ...
        public Product(string name, string producer) : this(name) => SetProducer(producer);
        ...
        public Product(string name, string producer, string date) : this(name, producer) => SetDate(date);
        ...
        public Product(string name, string producer, string date, float price) : this(name, producer, date) => SetPrice(price);
        ...
        public Product(string name, string producer, string date, float price, string comment) : this(name, producer, date, price) => SetComment(comment);

        /// <summary>
        /// Общая информация о товаре.
        /// </summary>
        /// <returns>Получение всей информации.</returns>
        public virtual string GetInfo() => $"Название товара - {name}, производитель - {producer}, дата изготовления - {date}, цена - {price}, комментарий - {comment}";

        /// <summary>
        /// Вывод исключения.
        /// </summary>
        /// <param name="ex">Исключение.</param>
        protected void ShowException(Exception ex) => Console.WriteLine(ex);
        ...
        public virtual string AddToJournal() => $"Дата: {DateTime.Now}, стоимость товара: {price}грн.\n";
        ...
        /// </summary>
        /// <param name="other">Объект сортировки</param>
        /// <returns>Числовое значение от -1 до 1</returns>
        public int CompareTo(object? other) => price.CompareTo((other as Product).price);
    }
}